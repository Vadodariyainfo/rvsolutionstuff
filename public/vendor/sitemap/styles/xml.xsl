...
<head>
<meta charset="utf-8"/>
<title>RvSolutionStuff : XML Sitemap</title>
...
.url:hover
{
  ...
  <body>
	<div id="content">
	  	<h2>XML Sitemap</h2>
		<p class="expl">Generated by <a href="https://rvsolutionstuff.com/sitemap.xml" target="_blank" title="Sitemap generator for Laravel">RvSolutionStuff</a>. This is styled xml sitemap, sorted by update date.</p>
