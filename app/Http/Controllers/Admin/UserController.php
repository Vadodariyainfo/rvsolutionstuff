        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('status',function($row){
                        if($row->user_type == 0){
                            if($row->status == 0){
                                $status = '<input type="checkbox" name="status" data-on="Active" data-off="Deactive"  checked data-onstyle="success" class="change-status toggle" data-offstyle="danger" data-toggle="toggle" data-id="'.$row->id.'">';
                            }
                            else{
                                $status = '<input type="checkbox" name="status" data-on="Active" data-off="Deactive" data-onstyle="success" class="change-status toggle" data-offstyle="danger" data-toggle="toggle" data-id="'.$row->id.'">';
                            }
                        }else{
                            $status = '-';
                        }
