                                    ...
                                    <div class="image-box">
                                        @if($value->image != null)
                                            <a class="btn btn-sm" href="{{ route('blog.detail',$value->slug) }}">
                                                <img class="lazyload" src="{!! !empty($value->image) ? route('image.asset.storage.file',['folder' => 'blog', 'file' => $value->image]) : asset('/blog/default/default.png') !!}" data-sizes="auto" alt="{{ $value->image }}" />
                                            </a>
                                        @else
                                            <a class="btn btn-sm" href="{{ route('blog.detail',$value->slug) }}">
